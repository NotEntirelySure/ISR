        ...
        <HeaderContainer render={({ isSideNavExpanded, onClickSideNavExpand }) => (
          <Header aria-label='admin header'>
            ...
            <SideNav
              ...
              <SideNavItems>
              <SideNavLink onClick={() => this.setState({modalSetupOpen:true})} renderIcon={Rocket32} element={Link} to="">Initial Setup</SideNavLink>
                <SideNavMenu renderIcon={UserAdmin32} title="Admin Pages">
                ...
                <SideNavLink renderIcon={Dashboard32} element={Link} to="/votedashboard">Vote Dashboard</SideNavLink>
                <SideNavLink renderIcon={ChartHistogram32} element={Link} to="/statistics">Statistics</SideNavLink>
                <SideNavLink renderIcon={Logout32} element={Link} to="/" onClick={() => this.HandleLogout()}>Logout</SideNavLink>
              </SideNavItems>
            </SideNav>
          </Header>
          )}
