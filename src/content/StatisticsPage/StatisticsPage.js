...
import { Renew32, DocumentExport32 } from '@carbon/icons-react';
import {
  Chart as ChartJS,
  CategoryScale,
  LinearScale,
...
class StatisticsPage extends Component {
  ...
  render () {
    return (
      <>
        <Content>
          <div className="bx--grid bx--grid--full-width statistics-page">
                  ...
                  render={({
                    ...
                    <TableContainer title="Project Ranks" description="Displays a rank-ordered list of projects">
                      <TableToolbar>
                        ...
                        <Button renderIcon={Renew32} hasIconOnly iconDescription='Refresh Table' onClick={() => this.UpdateStatTable()} />
                        <Button
